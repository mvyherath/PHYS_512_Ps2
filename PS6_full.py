...
# This function has an extended flat period in the middle.
# From the flat middle, it tapers off towards the edges.
# The shape of this window conserves the signal in the middle while tapering the edges.
...
for i in range(len(eventname)):
    ...
    for y in range(len(strains)):
        ...
        # Creating the Window Function (wnf)
        # By multiplying the strain with the wnf, the edges of the strain are damped out.
        # We take the Fourier Transform (FFT) of the strain multiplied by the window func
        # Then we create the noise model Nft by taking the absolute val. of the FFT
        ...
        #.... using a median filter. We use 9 points in a given region and move itteratively.
        # The median of 9 points in a given region is found.
        # These points are then divided by the median, and this is what does the smoothing.
        # The 9 point moving median/smoothing is conducted along all points of the......
        #.... Noise Template
